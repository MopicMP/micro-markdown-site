...
> Micro convert markdown folder to html site

[![PyPI version](https://badge.fury.io/py/micro-markdown-site.svg)](https://pypi.org/project/micro-markdown-site/)
...
```bash
pip install micro-markdown-site
```
...
result = site("Hello World")

# Example 2: Batch processing
from micro_markdown_site import batch
